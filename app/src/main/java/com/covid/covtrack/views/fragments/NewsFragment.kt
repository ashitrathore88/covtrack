...
class NewsFragment : Fragment(), CovidNewsRv.OnNewsListener {
    private lateinit var newsViewModel: NewsViewModel
    var root:View? =null
    private lateinit var newsList: ArrayList<CovidNews.NewsData>
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        newsViewModel.covidNewsResponse.observe(this, Observer {
            ...
            if (status.equals("valid")) {
                ...
                if (activity != null) AlertMessages.getInstance().alertMsgBox(it.message!!, requireActivity())
            }
        })
    ...
    private fun loadNewsItems(newsList: java.util.ArrayList<CovidNews.NewsData>) {
        ...
        val covidStatsRv = CovidNewsRv(newsList,this)
    ...
    override fun onItemClick(url:String, position: Int) {
        ...
        if(url.equals("#",ignoreCase = true)){
            intent.putExtra("TXT",true)
            intent.putExtra(Constants.NEWS_CONTENT, newsList[position])
        }
